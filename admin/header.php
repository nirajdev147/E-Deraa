  ...
  <div class="header">
                ...
                <div class="header-left">
					...
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/hlogo.png" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li>
								<a href="contactview.php"><i class="fe fe-comment"></i> <span> Contact </span> <span class="menu-arrow"></span></a>
							...
							<li>
								<a href="aboutview.php"><i class="fe fe-browser"></i> <span> About Page </span> <span class="menu-arrow"></span></a>
